...
config :starknet_explorer, StarknetExplorerWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: StarknetExplorerWeb.ErrorHTML, json: StarknetExplorerWeb.ErrorJSON],
    layout: false
  ],
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*  --external:/docs/*),
    cd: Path.expand("../assets", __DIR__),
