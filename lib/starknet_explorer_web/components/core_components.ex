defmodule StarknetExplorerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StarknetExplorerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StarknetExplorerWeb.Gettext, "errors", msg, opts)
    end
  end
